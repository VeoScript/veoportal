export const Facebook = (): JSX.Element => {
  return (
    <svg
      className="h-5 w-5 transform fill-current text-default-black dark:text-default-white"
...
export const Magaaazine = (): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="256.000000pt"
...
export const HandShakeIcon = (): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 512"
      fill="currentColor"
      className="h-[5rem] w-[5rem] transform fill-current text-default-dim-black dark:text-default-white"
    >
...
export const NextIcon = ({ className }: { className: string }): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const PreviousIcon = ({ className }: { className: string }): JSX.Element => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
