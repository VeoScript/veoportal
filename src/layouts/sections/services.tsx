...
const Services = (): JSX.Element | null => {
  ...
  return (
    <div className="-mt-[10rem] flex w-full flex-col items-center bg-default-ghost-white px-3 pb-[5rem] pt-[15rem] md:px-0">
      <div className="flex w-full max-w-5xl flex-col items-center gap-y-[5rem]">
        ...
        <div className="relative w-full">
          <span className="absolute w-full border border-neutral-200" />
          <div className="absolute -top-5 z-10 flex w-full flex-row items-center justify-center">
            <p className="flex w-[10rem] -rotate-12 justify-center rounded-full border border-neutral-200 bg-default-white px-10 py-4 text-sm font-semibold">
              Services
            </p>
          </div>
        </div>
