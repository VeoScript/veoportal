...
const SkillsServicesSection = dynamic(
  () => import("~/components/molecules/SkillsServicesSection"),
  { ssr: false }
);
const ExperiencesSection = dynamic(
  () => import("~/components/molecules/ExperiencesSection"),
  { ssr: false }
);
const TechStacksSection = dynamic(
  () => import("~/components/molecules/TechStacksSection"),
  { ssr: false }
);
    ...
    <>
      <Head>
        ...
        <meta
          name="url"
          property="og:url"
          content="https://jeromevillaruel.cf"
        />
        <meta
          name="site_name"
          property="og:site_name"
          content="Jerome Villaruel (Veoscript)"
        />
        <meta
          name="description"
        ...
        <meta
          ...
          content="https://i.ibb.co/xjzLnsv/page-image.png"
        />
        <meta
          name="image"
          property="og:image"
        ...
        <meta property="og:url" content="https://www.jeromevillaruel.cf/" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Jerome Villaruel" />
        <meta
          property="og:description"
          content="I'm Jerome Villaruel officially known as Veoscript, a software developer based in Philippines specializing in React, React Native, NextJS, NestJS, RestAPI, GraphQL, tRPC, Prisma, Supabase, and PlanetScale. I enjoy building dynamic web applications and leveraging these technologies to create robust and scalable solutions. Excited to collaborate on innovative projects and contribute to the world of software development."
        />
            ...
            <div className="flex flex-col items-center w-full space-y-10">
              ...
              >
                <Text
                  ...
                  weight="light"
                  size="xl"
                >{`"Let's keep it simple and focus on what matters. Don't let yourself be overwhelmed." - Confucius`}</Text>
