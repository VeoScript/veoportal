      ...
      {isCollapse && (
        <>
          ...
          <Link
            ...
            onClick={() => setIsCollapse(false)}
          >
            <svg className="w-8 md:w-10 h-8 md:h-10 text-white transition ease-in-out duration-200 transform hover:scale-90" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
